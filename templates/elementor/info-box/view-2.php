	...
	<div class="service-box">
		<div class="icon-holder <?php echo esc_attr( $bg_animation . ' ' . $icon_animation . ' ' . $image_invert ) ?>">
			...
			if ( 'image' == $icon_type ) {
				...
				echo "<span>";
				Icons_Manager::render_icon( $info_icon, [ 'aria-hidden' => 'true' ] );
				echo "</span>";
			}
				...
				<div class="read-more-btn <?php echo esc_attr( $read_more_btn_visibility ) ?>">
					<a class="button-el" href="<?php echo esc_url( $link['url'] ) ?>" <?php echo esc_attr( $target . ' ' . $nofollow ) ?>>
						<div class="button-text">
							<?php ( $btn_icon_position == 'left' ) ? Icons_Manager::render_icon( $button_icon, [ 'aria-hidden' => 'true' ] ) : null; ?>
							<span><?php echo esc_html( $read_more_btn_text ); ?></span>
							<?php ( $btn_icon_position == 'right' ) ? Icons_Manager::render_icon( $button_icon, [ 'aria-hidden' => 'true' ] ) : null; ?>
						</div>
					</a>
				</div>
			<?php endif; ?>
